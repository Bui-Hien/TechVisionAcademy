...
const ResourceForm = ({section, courseId}: ResourceFormProps) => {
    ...
    const [isDeleteSubmitting, setDeleteSubmitting] = useState<boolean>(false);
    const [idCourseDelete, setIdCourseDelete] = useState<string>("");
            ...
            <div className="mt-5 flex flex-col gap-5">
                {section.resources.map((resource) => (
                    <div key={resource.id}
                        ...
                        >
                            {isDeleteSubmitting && idCourseDelete == resource.id ? (
