...
const EditCourseForm = ({course, categories, levels, isCompleted}: courseFormProps) => {
        ...
        <>
            <div className="flex flex-col gap-2 sm:flex-row sm:justify-between mb-7">
                ...
                <div className="flex gap-4 items-start">
                    <PublishButton disabled={!isCompleted} courseId={course.id} isPublished={course.isPublished}
                                   page={"Course"}/>
                    ...
                    <FormField
                        ...
                        render={({field}) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input
                                        placeholder="Ex: Become a Full-stack Developer with just ONE course. HTML, CSS, Javascrip, Node, React, MongoDB and more!" {...field} />
                                </FormControl>
                                <FormMessage/>
                            </FormItem>
                        )}
